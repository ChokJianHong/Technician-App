      ...
      body: SingleChildScrollView(
        child: FutureBuilder<Map<String, dynamic>>(
          ...
          builder: (context, snapshot) {
            ...
            print(orderDetails); // This line helps to check the structure of the response
            ...
            String orderTime = 'Not available'; // Placeholder for order time
            String problemType = orderDetails['ProblemType'] ?? 'unknown'; // Added default value
            ...
            if (problemType == 'autogate') {
              ...
              brand = orderDetails['customer']['alarmBrand'] ?? 'Brand not available'; // Assuming this field exists
            } else {
              brand = 'Unknown brand';
            }
